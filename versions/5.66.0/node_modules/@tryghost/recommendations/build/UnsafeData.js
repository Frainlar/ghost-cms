...
class UnsafeData {
    ...
    optionalKey(key) {
        if (typeof this.data !== 'object' || this.data === null) {
            throw new errors_1.default.ValidationError({ message: `${this.fieldWithKey(key)} must be an object` });
        }
    ...
    regex(re) {
        ...
        if (!re.test(this.data)) {
            throw new errors_1.default.ValidationError({ message: `${this.field} must follow the format of "createdAt desc"` });
        }
        return this.data;
    }
}
